...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\28 Programmers\\Downloads\\MyStatement.pdf";

    /**
     * emeliyyatlari gostermek meqsedi ile yaradiriq
     * pdf-ni duzeldeceyik, mail vasitesile de gonderecik
     **/
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("The Kapital Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.RED);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("NASIMI RAY,71 FUZULI ST "));
        bankName.setBorder(0);
